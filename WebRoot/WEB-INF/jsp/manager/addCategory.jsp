    ...
    <div class="body">
    	<div class="container">
            ...
            <div class="right_block">
           	添加类别
            <hr />
			<form name="form2" method="post" action="/EShopping/manager/AddCategory.action" enctype="multipart/form-data">
     		<p/>类别名:&nbsp;&nbsp;
    ...
    <div class="body">
    	<div class="container">
            ...
            <div class="right_block">
           	添加类别
            <hr />
			<form name="form1" method="post" action="AddCategory.action" enctype="multipart/form-data" onsubmit="return verify()">
     		<p>类别名:&nbsp;&nbsp;
			<input name="categoryName" type="text" id="categoryname" ><font size="2" color="#FF0000" id="a"> *必填项</font>
			<br>
...
<html>
  ...
  <body>
    ...
    <form action="AddCategory.action" method="post">
    	<br>类别名：<input name="categoryName" type="text"/>
    	<br>父类别：
