			...
			<div class="bg_right">
				<div class="admin_right_to_center">
					<div class="right_block">
			            <form id="form_dingdang" name="form2" method="post" action="/BookShopping/manager/ModifyCategory.action" enctype="multipart/form-data">
			            	修改类别
			            	<button id="search_sale" type="button" class="btn btn-success" style="float:right" onclick="to_back()">返回</button>
				            <hr />
							...
							<br />
				            <input type="button" class="btn btn-success" value="确认修改" onclick="verify('${requestScope.Category.categoryName}')"/>
