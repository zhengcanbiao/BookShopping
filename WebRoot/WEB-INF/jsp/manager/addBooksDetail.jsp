			...
			<div class="bg_right">
				<div class="admin_right_to_center">
					<div class="right_block">
			            <form id="form_dingdang" name="form2" method="post" action="/BookShopping/manager/AddBooksDetail.action" enctype="multipart/form-data">
			            	添加商品
							...
							<p/>出版日期:
							<input name="publicationDate" type="text" id="material_date" />
				            ...
				            <p/>商品图片:&nbsp;&nbsp;
				   			...
				   			<font size="2" color="#FF0000" id="a" style="float:right; margin-right:320px; margin-top:-23px;"> *必选项</font>
				            <pre style="float:inherit; margin-bottom:5px;">商品介绍:
							<textarea style="float:left; margin-left:20px; height: 100px; width: 538px;" name="booksDescription" id="ClothesDescription" class="introduce"></textarea>
				            </pre>
				            <input type="submit" class="btn btn-success" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" style="float:left;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 			</form>
			            <br />
					</div>
				</div>
