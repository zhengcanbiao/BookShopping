...
<body>
    ...
    <div class="body">
    	...
    	<div class="container">
            ...
            <a href="/EShopping/customer/PrepareOrderInfoList.action" style="margin-left:22px;">查看我的订单</a><br>
            <a href="/EShopping/customer/RedirectToHome.action" style="margin-left:22px;">回首页</a>
